...
class provience(models.Model):
    provience_name=models.CharField(max_length=200,null=False,blank=False)
    provience_code=models.CharField(max_length=10,null=False,blank=False)
    capital=models.CharField(max_length=20,null=False,blank=False)